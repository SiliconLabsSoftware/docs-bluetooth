...
For more details about the RCP mode, refer to [Enabling a Radio Co-Processor using the Bluetooth LE HCI Function](/bluetooth/{build-docspace-version}/enabling-rcp-using-bt-hci).
