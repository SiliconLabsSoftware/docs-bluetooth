...
- [**Programming Series 2 Devices Using the DCI and SWD**](/bluetooth/{build-docspace-version}/efr32-dci-swd-programming): Describes how to provision and configure Series 2 devices through the DCI and SWD.
- [**Integrating Crypto Functionality with PSA Crypto vs. Mbed TLS**](/bluetooth/{build-docspace-version}/mbedtls-psa-crypto-porting-guide): Describes how to integrate crypto functionality into applications using PSA Crypto compared to Mbed TLS.
